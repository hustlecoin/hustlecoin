...
{
    const char* pszTimestamp = "hustlecoin";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // we wont use this
        ...
        genesis = CreateGenesisBlock(1620689319, 498698, 0x1e0fffff, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("7318d4f5d35047677533e91a5374af38f1f4b7a4145f66e3608fbaacfa8584ee"));
        ...
        checkpointData = {
            {
                {     0, uint256S("7318d4f5d35047677533e91a5374af38f1f4b7a4145f66e3608fbaacfa8584ee") },
                {     1, uint256S("e9d779cae00a938eda24782b3f910b1eebadbe491a17e314a991a7cf24b08d63") }
            }
        };
