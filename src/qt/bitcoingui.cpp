...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Hustle address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hustle: URIs)"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Hustle addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Hustle addresses"));
    ...
    openAction->setStatusTip(tr("Open a hustle: URI"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Hustle network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
