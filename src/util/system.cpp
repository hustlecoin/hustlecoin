...
const char * const BITCOIN_CONF_FILENAME = "hustle.conf";
...
{
    // Windows: C:\Users\Username\AppData\Roaming\Hustle
    // macOS: ~/Library/Application Support/Hustle
    // Unix-like: ~/.hustle
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Hustle";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Hustle";
#else
    // Unix-like
    return pathRet / ".hustle";
#endif
#endif
}
